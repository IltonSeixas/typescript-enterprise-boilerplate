...
TypeScript's structural typing makes the port/adapter pattern natural: any class with the right method signatures satisfies an interface, with no decorator required.
